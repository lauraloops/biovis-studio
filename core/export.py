...
def export_notebook(state, out_dir: str | None = None) -> str:
    """
    Create a lightweight reproducibility Jupyter notebook from Streamlit session_state.
    Returns the full path to the saved .ipynb file.
    """
    # Default to a local, user-writable directory
    if out_dir is None:
    ...
    # Include a preview of processed data if available
